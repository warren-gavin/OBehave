...
// MARK: - OBEmptyDataSetBehaviorDataSource
public protocol OBEmptyDataSetBehaviorDataSource {
    func viewToDisplayOnEmpty(for Behavior: OBEmptyDataSetBehavior?) -> UIView?
}
...
// MARK: - Behavior
public class OBEmptyDataSetBehavior: OBBehavior {
...
private extension OBEmptyDataSetBehavior {
...
private struct Constants {
    static var isSwizzledKey = "com.apokrupto.OBEmptyDataSetBehavior.isSwizzled"
...
extension DataDisplaying {
    ...
    var emptyStateDataSource: OBEmptyDataSetBehaviorDataSource? {
        get {
            return objc_getAssociatedObject(self, &Constants.emptyStateDataSourceKey) as? OBEmptyDataSetBehaviorDataSource
        }
